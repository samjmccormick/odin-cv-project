...
function GeneralCombined () {
    ...
    return (
        <>
            {!isSubmit && <GeneralForm name={fullName} email={email} phoneNumber={phoneNumber}
            ...
            />}
            {isSubmit && <General name={fullName} email={email} phoneNumber={phoneNumber} onClick={handleEdit}/>}
        </>
    )
}
